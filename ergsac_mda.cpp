...
{   //string imageName("lincoln2.png");
    ...
    migmda<DoubleInt,ergodicost<DoubleInt>> demon(&sacsys, false);//mda demon(PI/4, false);
    arma::vec xwrap;
    syst1.Ucurr = unom(0); 
    ...
    cout<<syst1.Xcurr<<"\n";
    uniform_real_distribution<> user(-40,40);
    //normal_distribution<double> user(0,30);
    ...
    syst1.Ucurr = demon.filter(input);//sacsys.ulist.col(0),input);
